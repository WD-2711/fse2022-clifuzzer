...
wget --no-hsts https://ftp.gnu.org/gnu/spell/spell-1.0.tar.gz
tar -zxf spell-1.0.tar.gz
mv spell-1.0 spell
...
# **** The following compiler flags are not actually set. Not sure why. ****
# **** Manually update the Makefile if you wish to get coverage. Also in afl compilation. ****
