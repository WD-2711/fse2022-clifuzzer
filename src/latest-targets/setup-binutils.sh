...
echo "Downloading and compiling binutils-2.37 (for as, nm, strings, strip 2.37) now"
wget --no-hsts  https://ftp.gnu.org/gnu/binutils/binutils-2.37.tar.gz
...
# binaries -  ./gas/as-new, ./binutils/[nm-new, strings, strip-new]
# man - ./gas/doc/, ./binutils/doc
cd $DIR
