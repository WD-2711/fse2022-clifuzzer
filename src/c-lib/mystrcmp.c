...
/*
 *Code to return values passed to strcmp and strncmp library functions
 *and then optionally call the actual strcmp function
 */
#define _GNU_SOURCE
#include <stdio.h>
#include <string.h>
...
strcmp (const char *p1, const char *p2)
{
    ...
    //The next three lines call the actual strcmp function
...
strncmp(const char *s1, const char *s2, size_t n)
{
    ...
    //The next three lines call the actual strncmp function
    //Comment out if not needed
