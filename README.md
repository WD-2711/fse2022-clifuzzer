...
with 16 gigabytes of RAM. The container runs Ubuntu 20.04.3 LTS with the same
...
| targets                      | The directory containing all the target utilities in their older versions, compiled with gcc|
...
The last column contains one example of an option not present in the documentation of the utility, where applicable.
Some of those utilities have more undocumented options present in their code.
